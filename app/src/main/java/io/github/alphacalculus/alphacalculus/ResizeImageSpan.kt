 ...
 */
class ResizeImageSpan(d: Drawable, // TextView's width.
                      private val mContainerWidth: Int) : ImageSpan(d) {
    ...
    private fun getResizedDrawableBounds(d: Drawable?): Rect {
        ...
        if (d.intrinsicWidth < mContainerWidth) {
            ...
            if (d.intrinsicWidth > MIN_SCALE_WIDTH && d.intrinsicWidth >= d.intrinsicHeight) {
    ...
    companion object {
        ...
        private val MIN_SCALE_WIDTH = 240
    }
}